        ...
        earthquakes: [
            {
                ...
                damage: "Kerusakan katastropik: 70,000 rumah hancur total (60%), 400 fasilitas publik rusak, tsunami 0.5-1.5m merusak pantai Palu, 14 warung makan terendam, koridor jalan utama terputus, ekonomi lokal rugi ~$400 juta"
            },
            {
        ...
        earthquakes: [
            {
                ...
                damage: "Tsunami setinggi 3-4 meter: 10,000 rumah terendam air asin, ribuan perahu nelayan tenggelam, pelabuhan Donggala rusak total, infrastruktur irigasi terusak, kerugian nelayan ~$150 juta"
            }
        ]
    },
    {
        ...
        earthquakes: [
            {
                ...
                damage: "Kerusakan sedang: 8,000 rumah rusak berat, 80 sekolah tertimpa reruntuhan, jalan poros terputus di 10 titik, sistem irigasi pertanian rusak sepanjang 50km, kerugian pertanian ~$50 juta"
            }
        ]
    },
    {
        ...
        earthquakes: [
            {
                ...
                damage: "Kerusakan ringan-sedang: 5,000 rumah rusak, 50 jembatan retak, jalan poros putus di 5 titik, fasilitas publik terganggu, kerugian estimasi ~$30 juta"
            }
        ]
    },
    {
        ...
        risk: "Rendah",
        image: "images/buol.jpg",
        description: "Buol merupakan daerah dengan risiko gempa RENDAH namun tetap dalam area monitoring nasional BMKG. Karakteristik area: letak geografis di utara Sulteng dengan jarak dari fault line tektonik utama. Meskipun risiko rendah, mitigasi tetap dilaksanakan: (1) Monitoring gempa berkelanjutan melalui pusat peringatan dini regional, (2) Edukasi kesiapan gempa dasar di sekolah-sekolah, (3) Penyiapan 3 shelter darurat untuk protokol tanggap darurat, (4) Koordinasi informasi gempa dari BMKG, (5) Sosialisasi pentingnya kesiapan (preparedness mindset).",
        ...
        earthquakes: [
            {
                ...
                deaths: "0",
                injuries: "0",
                damage: "Area relatif stabil secara seismik. Monitoring gempa tetap berjalan sebagai standar protokol nasional."
            }
        ]
    },
    {
        ...
        earthquakes: [
            {
                ...
                deaths: "0",
                injuries: "0",
                damage: "Area relatif stabil. Monitoring tetap berjalan sesuai standar nasional emergency preparedness."
            }
        ]
    },
    {
        ...
        earthquakes: [
            {
                ...
                deaths: "50+ orang",
                injuries: "200+ orang",
                damage: "Kerusakan ringan-sedang: rumah tradisional retak, jalan pedesaan amblas, jembatan gantung rusak, fasilitas publik terganggu parsial, kerugian lokal ~$8 juta"
            }
        ]
    },
    {
        ...
        earthquakes: [
            {
                ...
                deaths: "30+ orang",
                injuries: "100+ orang",
                damage: "Kerusakan kecil-sedang: bangunan tradisional retak, perahu nelayan rusak, jalur laut terganggu navigasi, fasilitas publik parsial terganggu, kerugian nelayan ~$5 juta"
            }
        ]
    },
    {
        ...
        risk: "Sedang",
        image: "images/banggai.jpg",
        description: "Banggai adalah kabupaten dengan risiko SEDANG, mayoritas komunitas adalah nelayan dan petani. Letak pantai meningkatkan risiko tsunami minor. Rencana mitigasi komprehensif: (1) Pelatihan khusus nelayan dan petani tentang recognizing tsunami signs dan evakuasi cepat, (2) Sistem early warning terintegrasi dengan 6 pos pemantauan gempa tersebar, (3) Penyiapan 4 shelter darurat di lokasi aman dengan kapasitas 3,000 orang, (4) Edukasi masyarakat melalui kelompok nelayan dan kelompok tani, (5) Koordinasi dengan Dinas Kelautan untuk kesiapan operasi penyelamatan laut.",
        population: "~140,000 jiwa (sebagian nelayan & petani)",
        infrastructure: "14+ sekolah, 2 rumah sakit, 70+ kantor dinas",
        facilities: "6 pos pemantauan gempa, 4 shelter darurat, 1 pos operasi darurat",
        earthquakes: [
            {
                date: "2015 & 2019",
                ...
                deaths: "20+ orang",
                injuries: "150+ orang",
                damage: "Kerusakan ringan-sedang: 2,000 rumah rusak, 30 fasilitas publik terganggu, jalan poros retak sepanjang 20km, port pelabuhan rusak parsial, kerugian pelabuhan ~$3 juta"
            }
        ]
    },
    {
        ...
        earthquakes: [
            {
                ...
                deaths: "80+ orang",
                injuries: "300+ orang",
                damage: "Tsunami setinggi 2-3 meter: ribuan rumah terendam, pulau terintegrasi terisolasi selama berminggu-minggu, supply chain putus, infrastruktur merata hancur, kerugian estimasi ~$20 juta, trauma psikologis masif pada populasi"
            }
        ]
    },
    {
        ...
        earthquakes: [
            {
                ...
                deaths: "35+ orang",
                injuries: "180+ orang",
                damage: "Kerusakan sedang: 3,500 rumah rusak, 25 fasilitas publik terganggu, jalan poros retak sepanjang 15km, irigasi pertanian terganggu, kerugian pertanian ~$12 juta"
            }
        ]
    },
    {
        ...
        earthquakes: [
            {
                ...
                deaths: "65+ orang",
                injuries: "280+ orang",
                damage: "Tsunami setinggi 1.5-2 meter: ribuan rumah terendam, perahu nelayan rusak, supply chain terputus minggu, infrastruktur merata terganggu, kerugian estimasi ~$18 juta"
            }
        ]
    },
    {
        ...
        earthquakes: [
            {
                ...
                deaths: "40+ orang",
                injuries: "160+ orang",
                damage: "Kerusakan ringan-sedang: rumah tradisional retak, infrastruktur jalan amblas, jembatan gantung rusak, fasilitas publik parsial terganggu, kerugian lokal ~$10 juta"
            }
        ]
    }
];
